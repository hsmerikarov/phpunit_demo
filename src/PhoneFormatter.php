...
class PhoneFormatter
{
    ...
    public function getAllCountries() {
        ...
        $countries[] = array("code"=>"AS","name"=>("American Samoa"),"d_code"=>"+1684");
        ...
        $countries[] = array("code"=>"VG","name"=>("British Virgin Islands"),"d_code"=>"+1340");
        ...
        $countries[] = array("code"=>"MC","name"=>("Monaco"),"d_coPHP convert phone number to international formatde"=>"+377");
        ...
        $countries[] = array("code"=>"VA","name"=>("Vatican City"),"d_code"=>"+379");
